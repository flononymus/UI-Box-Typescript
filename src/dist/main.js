...
try {
  process.dlopen(module, __dirname + (__webpack_require__(/*! path */ "path").sep) + __webpack_require__.p + "b14a3663a9cc2b23b7801a037e710ee4.node");
} catch (error) {
...
__webpack_require__(/*! electron-reload */ "./node_modules/electron-reload/main.js")(__dirname, {
    electron: node_path_1.default.join(__dirname, 'node_modules/.bin/electron.cmd')
});
